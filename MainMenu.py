        ...
        if counter == 0:
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.MOUSEBUTTONDOWN:
                    ...
                    row, col, index = find_index_from_xy(mouse_x,mouse_y)  # using a function to find the row and column number
            ...
            display_score = font_obj.render(f"score : {str(score)} ", True, font_color)
            sub2.blit(display_score, (515, 200))  # for displaying score and tmr
            display_tmr = font_obj.render(f"time left : {txt}", True, font_color)
            sub2.blit(display_tmr, (200, 520))
            total_skipped = 0
            for i, tile in enumerate(tiles):
                ...
                if not tile.skip:
                    sub2.blit(current_image,(tile.col * gc.IMAGE_SIZE + gc.MARGIN, tile.row * gc.IMAGE_SIZE + gc.MARGIN))
                        # iterating over tiles and displaying them
                        # enumerate gives the iterator index
                else:
                    total_skipped += 1

            display.flip()  # update the sub2 with display.flip()
            ...
            if len(current_images_displayed) == 2:
                ...
                if tiles[idx1].name == tiles[idx2].name:
                    ...
                    score += 1
                    display_score = font_obj.render(f"score : {str(score)} ", True, font_color)
                    sub2.blit(display_score, (22, 520))  # for displaying score and tmr
                    sleep(0.2)
                    sub2.blit(matched, (0, 0))
                    display.flip()
                    sleep(0.5)
                    current_images_displayed = []
...
def multsnum(counter):
    ...
    while ct:
        if counter == 0:
            ...
            tt = str(timer).rjust(3) if counter > 0 else "0:00:00"
            k = font.render(tt, True, "black")
            b4 = Button(image=None, pos=(60, 100), text_input="Back", font=gfont(), base_color="white",hovering_color="orange")
            if ch == 1:
                b1 = Button(image=None, pos=(250, 330), text_input=str(ans), font=gfont(), base_color="white",hovering_color="orange")
                b2 = Button(image=None, pos=(400, 330), text_input=str(rand1), font=gfont(), base_color="white",hovering_color="orange")
                b3 = Button(image=None, pos=(250, 450), text_input=str(rand2), font=gfont(), base_color="white",hovering_color="orange")
                b5 = Button(image=None, pos=(400, 450), text_input=str(rand3), font=gfont(), base_color="white",hovering_color="orange")
            elif ch == 2:
                b1 = Button(image=None, pos=(250, 330), text_input=str(rand1), font=gfont(), base_color="white",hovering_color="orange")
                b2 = Button(image=None, pos=(400, 330), text_input=str(ans), font=gfont(), base_color="white",hovering_color="orange")
                b3 = Button(image=None, pos=(250, 450), text_input=str(rand2), font=gfont(), base_color="white",hovering_color="orange")
                b5 = Button(image=None, pos=(400, 450), text_input=str(rand3), font=gfont(),base_color="white",hovering_color="orange")
            elif ch == 3:
                b1 = Button(image=None, pos=(250, 330), text_input=str(rand1), font=gfont(), base_color="white",hovering_color="orange")
                b2 = Button(image=None, pos=(400, 330), text_input=str(rand2), font=gfont(),base_color="white",hovering_color="orange")
                b3 = Button(image=None, pos=(250, 450), text_input=str(ans), font=gfont(), base_color="white",hovering_color="orange")
                b5 = Button(image=None, pos=(400, 450), text_input=str(rand3), font=gfont(), base_color="white",hovering_color="orange")
            else:
                b1 = Button(image=None, pos=(250, 330), text_input=str(rand1), font=gfont(),base_color="white",hovering_color="orange")
                b2 = Button(image=None, pos=(400, 330), text_input=str(rand2), font=gfont(),base_color="white",hovering_color="orange")
                b3 = Button(image=None, pos=(250, 450), text_input=str(rand3), font=gfont(), base_color="white",hovering_color="orange")
                b5 = Button(image=None, pos=(400, 450), text_input=str(ans), font=gfont(), base_color="white",hovering_color="orange")
    ...
    while ct:
        if counter == 0:
            ...
            if ch == 1:
                ...
                b2 = Button(image=None, pos=(400, 330), text_input=str(rand1), font=gfont(), base_color="white",hovering_color="orange")
                b3 = Button(image=None, pos=(250, 450), text_input=str(rand2), font=gfont(), base_color="white",hovering_color="orange")
                b5 = Button(image=None, pos=(400, 450), text_input=str(rand3), font=gfont(), base_color="white",hovering_color="white")
            elif ch == 2:
                b1 = Button(image=None, pos=(250, 330), text_input=str(rand1), font=gfont(), base_color="white",hovering_color="orange")
                b2 = Button(image=None, pos=(400, 330), text_input=str(ans), font=gfont(), base_color="white",hovering_color="orange")
                b3 = Button(image=None, pos=(250, 450), text_input=str(rand2), font=gfont(), base_color="white",hovering_color="orange")
...
def display_mathgame(counter):
    ...
    while ct:
        if counter == 0:
            ...
            tt = str(timer).rjust(3) if counter > 0 else "0:00:00"
            k = font.render(tt, True, "black")
            b1 = Button(image=None, pos=(320, 250), text_input="Addition", font=gfont(), base_color="black",hovering_color="white")
            b2 = Button(image=None, pos=(320, 300), text_input="Subtraction", font=gfont(), base_color="black",hovering_color="white")
            b3 = Button(image=None, pos=(320, 350), text_input="Multiplication", font=gfont(), base_color="black",hovering_color="white")
            b4 = Button(image=None, pos=(60, 100), text_input="Back", font=gfont(), base_color="black",hovering_color="white")
            b5 = Button(image=None, pos=(320,400), text_input="Division",font= gfont(), base_color="black",hovering_color="white")
...
def display_menu(counter):
    ...
    while dm:
        ...
        screen.blit(sub1, (0, 0))
        screen.blit(sub2, (0, 80))
        b1 = Button(image=memor, pos=(120, 250), text_input="", font=gfont(), base_color="black",hovering_color="white")
        b2 = Button(image=worpuz, pos=(480, 250), text_input="", font=gfont(), base_color="black",hovering_color="white")
...
def mainmen(counter):
    ...
    while chkr:
        ...
        screen.blit(sub1, (0, 0))
        screen.blit(sub2, (0, 80))
        b1 = Button(image=None, pos=(320, 250), text_input="Menu", font=gfont(), base_color="black", hovering_color="white")
        b2 = Button(image=None, pos=(320, 300), text_input="About", font=gfont(), base_color="black", hovering_color="white")
        b3 = Button(image=None, pos=(320, 350), text_input="Quit", font=gfont(), base_color="black", hovering_color="white")
